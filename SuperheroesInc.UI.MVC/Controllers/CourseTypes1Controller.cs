...
{
    public class CourseTypes1Controller : Controller
    {
        ...
        // GET: CourseTypes1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: CourseTypes1/Create
